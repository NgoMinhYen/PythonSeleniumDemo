import json
from core.driver.config import constants
from core.util import utils
# from importlib_metadata._compat import FileNotFoundError
# from core.util import utils
...
class DriverConfig(object):
    ...
    def __init__(self, remote_host, platform, browser, executable, capabilities={}, options={}, arguments=[]):
        ...
        self._mode = "local" if "" == remote_host else "remote"
