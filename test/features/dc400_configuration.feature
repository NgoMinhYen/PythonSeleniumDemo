...
Feature: The map is zoomed out
    Scenario: GSX-3529 - User can select Go to configuration option to go to Configuration page
        ...
        When Search device with device id: '0203030521054073'
        Then Expected: Device: '0203030521054073' is displayed
        When Click (Go to configuration) icon in device item '0203030521054073'
        Then Device '0203030521054073' configuration page is displayed